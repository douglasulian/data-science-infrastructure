...
c.LDAPAuthenticator.server_address = 'ldap.rbs.net'
c.LDAPAuthenticator.bind_dn_template = ['cn={username},ou=Usuarios,ou=Corp,ou=RBS,dc=RBS,dc=NET',
                                        'cn={username},ou=Usuarios,ou=ZH,ou=JORNAIS,ou=RBS,dc=RBS,dc=NET',
                                        'cn={username},ou=Usuarios Temporarios,ou=Recursos,dc=RBS,dc=NET']
#c.LDAPAuthenticator.allowed_groups = ['cn=G-DataScience_JupyterHub,ou=Grupos de Servico,ou=Recursos,dc=RBS,dc=NET']
c.LDAPAuthenticator.use_ssl = True
c.LDAPAuthenticator.server_port = 636
c.LDAPAuthenticator.valid_username_regex = '^[a-zA-Z][.a-zA-Z0-9_-]*$'
c.LDAPAuthenticator.create_user_home_dir = True
c.LDAPAuthenticator.create_user_home_dir_cmd = ['/home/create_user.sh']
...
#c.JupyterHub.ssl_cert = '/etc/httpd/httpscertificate/jupyterhub.rbs.com.br.crt'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
#c.JupyterHub.ssl_key = ''
#c.JupyterHub.ssl_key = '/etc/httpd/httpscertificate/jupyterhub.rbs.com.br.key'
...
c.Authenticator.admin_users = {'douglas_ulian'}
